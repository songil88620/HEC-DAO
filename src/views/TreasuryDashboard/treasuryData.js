...
export const tooltipItems = {
  ...
  coin: ["DAI", "USDC", "MiM", "FRAX", "gWAND", "WFTM"],
  apy: ["APY"],
  runway: ["Days"],
...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all WAND staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing WAND.",
  ...
  staked: "WAND Staked, is the ratio of sWAND to WAND (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sWAND emissions can be sustained at a given rate. Lower APY = longer runway",
};
